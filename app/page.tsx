    ...
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          Bring your ideas to life with the power of creativity and hard work. Success begins with believing in your vision and taking the first step toward making it a reality.
          </p>
